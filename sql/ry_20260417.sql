...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '东方有线',   0, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '金山东方有线', 1, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '市场部门',   1, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(104,  101, '0,100,101',  '研发部门',   2, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
-- insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_user values(2,  105, 'ry',    'admin', '00', 'test@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- 初始化-岗位信息表数据
-- ----------------------------
insert into sys_post values(1, 'ceo',  '超级管理员',    1, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(2, 'se',   '管理员',  2, '0', 'admin', sysdate(), '', null, '');
