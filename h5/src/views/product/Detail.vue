  ...
  <div class="product-detail">
    ...
    <div class="content" v-if="goods">
      ...
      <div class="card">
        ...
        <div class="desc" v-html="goods.description || '<div style=\'color:#999\'>暂无详情</div>'"></div>
      </div>
    </div>
...
.cover { width: 100%; aspect-ratio: 1 / 1; object-fit: cover; background: #fff; }
.card {
